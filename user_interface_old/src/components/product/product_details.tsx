...
export default function ProductDetailsComponent() {
  ...
  const handleVariantChange = (attribute: string, value: string) => {
    ...
    if (
      Object.keys(updatedVariants).length ===
      Object.keys(product?.skus[0]?.variants_dict || {}).length
    ) {
                            ...
                            <span className="flex-1">
                              {
                                typeof value === "object" && value !== null
                                  ...
                                  : value // Render as is if it's a string or number
                              }
                            </span>
                          </li>
                        ),
                                ...
                                {getUniqueOptions(attribute).map(
                                  (value, index) => (
                                    <button
                                      ...
                                      onClick={() =>
                                        handleVariantChange(attribute, value)
                                      }
                                    >
                                      {value}
                                    </button>
